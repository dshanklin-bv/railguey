...
<style>
  :root { --bg:#0c0d0b; --fg:#e8e6df; --muted:#8b8a82; --subtle:#5c5b55; --line:rgba(232,230,223,.12); --ok:#7d9a78; --warn:#b9a27a; --danger:#c17a74; --surface:#161714; }
  * { box-sizing: border-box; }
  ...
  .kicker { font-size:11px; letter-spacing:.16em; text-transform:uppercase; color:var(--muted); margin: 14px 0 0; }
  ...
  button, .btn { display:inline-flex; align-items:center; justify-content:center; height:44px; padding:0 18px; border:0; border-radius:8px; background:#c8ccd4; color:var(--bg); font: 600 14px/1 "IBM Plex Sans", sans-serif; cursor:pointer; }
